...
- (id)init
{
  ...
  {
		//Colors
		UIColor *colorOne		= [UIColor colorWithHue:0.581 saturation:0.27 brightness:0.15 alpha:1.0];
		UIColor *colorTwo		= [UIColor colorWithHue:0.581 saturation:0.27 brightness:0.15 alpha:1.0];
		UIColor *colorThree	        = [UIColor colorWithHue:0.581 saturation:0.27 brightness:0.8 alpha:1.0];
		UIColor *colorFour		= [UIColor colorWithHue:0.581 saturation:0.27 brightness:0.8 alpha:1.0];
		UIColor *colorFive		= [UIColor colorWithHue:0.581 saturation:0.27 brightness:0.5 alpha:1.0];
		UIColor *colorSix		= [UIColor colorWithHue:0.581 saturation:0.27 brightness:0.2 alpha:1.0];
