...
- (id)init
{
  ...
  {
		//Colors
		UIColor *colorOne		= [UIColor colorWithHue:0.581 saturation:0.27 brightness:0.74 alpha:1.0];
		UIColor *colorTwo		= [UIColor colorWithHue:0.581 saturation:0.27 brightness:0.50 alpha:1.0];
		UIColor *colorThree	= [UIColor colorWithHue:0.581 saturation:0.27 brightness:0.325 alpha:1.0];
		UIColor *colorFour		= [UIColor colorWithHue:0.581 saturation:0.27 brightness:0.2 alpha:1.0];
		UIColor *colorFive		= [UIColor colorWithHue:0.581 saturation:0.27 brightness:0.2 alpha:1.0];
